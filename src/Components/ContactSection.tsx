...
function ContactSection() {
  ...
  async function contactSubmission(e:any){
    ...
    window.location.href = link;
      ...
      return <div className="container contact-form-container" id="contact">
        <div className="main-section">
          <h2>Contact</h2>
          <div className="contact-info">
            <form className="contact-form" action="" onSubmit={e => {e.preventDefault();}}>
              <label className="contact-form-label" htmlFor="fname">First Name:</label>
              <input type="text" id="fname" name="firstname" placeholder="Your name..."></input>
              <label className="contact-form-label" htmlFor="lname">Last Name:</label>
              <input type="text" id="lname" name="lastname" placeholder="Your last name..."></input>
              <label className="contact-form-label" htmlFor="subject">Subject:</label>
              <textarea className="contact-form-textarea" id="subject" name="subject" placeholder="Message..."></textarea>
